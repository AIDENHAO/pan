 ...
 * 测试高级业务逻辑操作
 */
import { DatabaseService } from '../implementations/DatabaseService.js';
/**
 * DatabaseService 测试类
 */
export class DatabaseServiceTester {
     ...
     * 测试创建完整人物
     */
    async testCreateCompleteCharacter() {
        const characterData = {
            baseInfo: {
     ...
     * 测试获取完整人物信息
     */
    async testGetCompleteCharacterInfo() {
