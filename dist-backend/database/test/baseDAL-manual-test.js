...
import { CharacterBaseInfoDAL, CharacterAffinitiesDAL, ItemDataDAL } from '../implementations/CharacterDALs.js';
/**
 * 测试工具类
 */
class BaseDALTester {
    constructor() {
        this.results = [];
        this.testCharacterId = 'test_char_001';
...
//# sourceMappingURL=baseDAL-manual-test.js.map