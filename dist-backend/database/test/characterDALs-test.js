...
import { CharacterBaseInfoDAL, CharacterAffinitiesDAL, CharacterStrengthDAL, CharacterBodyTypesDAL, CharacterSkillsDAL, CharacterWeaponsDAL, CharacterCurrencyDAL, CharacterItemsDAL, RealmDataDAL, BodyTypeDataDAL, SkillDataDAL, WeaponDataDAL, ZongmenDataDAL, AchievementDataDAL, ItemDataDAL, ItemTypeCategoryDAL, ItemTypeRelationsDAL } from '../implementations/CharacterDALs.js';
/**
 * CharacterDALs测试工具类
 */
class CharacterDALsTester {
     ...
     */
    async testCharacterBaseInfoDAL() {
        // 测试查找所有角色
     ...
     */
    async testCharacterAffinitiesDAL() {
     ...
     */
    async testCharacterStrengthDAL() {
        if (!this.testCharacterId) {
            throw new Error('需要先设置测试角色ID');
        }
        // 测试根据角色ID查找
     ...
     */
    async testCharacterBodyTypesDAL() {
        if (!this.testCharacterId) {
            throw new Error('需要先设置测试角色ID');
        }
        // 测试根据角色ID查找
     ...
     */
    async testCharacterCurrencyDAL() {
        if (!this.testCharacterId) {
            throw new Error('需要先设置测试角色ID');
        }
        // 测试根据角色ID查找
    ...
    async testSkillDataDAL() {
        ...
        if (allSkills.length > 0) {
            ...
            // 测试根据境界要求查找
            const skillsByRealm = await this.skillDataDAL.findByRealmRequirement(skill.realm_requirement || 1);
    ...
    async testWeaponDataDAL() {
        ...
        if (allWeapons.length > 0) {
            ...
            // 测试根据境界要求查找
            const weaponsByRealm = await this.weaponDataDAL.findByRealmRequirement(weapon.realm_requirement || 1);
     ...
     */
    async testItemTypeRelationsDAL() {
        // 测试查找所有关系
...
//# sourceMappingURL=characterDALs-test.js.map