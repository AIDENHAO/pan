...
export class DatabaseUsageExample {
   ...
   * 初始化数据库示例
   */
  static async initializeExample(): Promise<void> {
    try {
   ...
   * 创建人物示例
   */
  static async createCharacterExample(): Promise<CompleteCharacterInfo> {
   ...
   * 查询人物示例
   */
  static async queryCharacterExample(characterId: string): Promise<CompleteCharacterInfo | null> {
    try {
   ...
   * 修炼示例
   */
  static async cultivationExample(characterId: string): Promise<void> {
    try {
      console.log('开始修炼...');
   ...
   * 物品管理示例
   */
  static async itemManagementExample(characterId: string): Promise<void> {
    try {
   ...
   * 搜索示例
   */
  static async searchExample(): Promise<void> {
    try {
      console.log('开始搜索示例...');
   ...
   * 统计信息示例
   */
  static async statisticsExample(): Promise<void> {
    try {
      console.log('获取统计信息...');
   ...
   * 完整的使用流程示例
   */
  static async fullExample(): Promise<void> {
    try {
      // 1. 初始化数据库
