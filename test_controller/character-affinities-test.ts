...
import { CharacterAffinitiesDAL, CharacterBaseInfoDAL } from '../src/database/implementations/CharacterDALs.js';
import { CharacterAffinities, CharacterBaseInfo } from '../src/database/interfaces/types.js';
